...
onload = () => {
    ...
    if (theme != "") {
        if (theme == "light")
            print("Cookie them value set to light : No change needed")

        else if (theme == "dark") {
            print("Cookie theme value set to dark : Changing theme")
            changeClass(document.getElementById("mainFrame"), "lightTheme", "darkTheme")
            changeClass(document.getElementById("header"), "headerLight", "headerDark")
